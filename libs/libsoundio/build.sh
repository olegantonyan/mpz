...
CC=$COMPILER cmake $SOURCE_DIRECTORY -DCMAKE_BUILD_TYPE=release -DBUILD_STATIC_LIBS=ON -DBUILD_EXAMPLE_PROGRAMS=OFF -DBUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX=$INSTALL_DIRECTORY -DCMAKE_INSTALL_LIBDIR=lib && \
make -j8 && \
make install && \
