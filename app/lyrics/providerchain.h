...
namespace Lyrics {
  // Walks enabled online providers in the user-configured order, advancing on notFound/failed. Emits found(provider_name, lyrics) or
  ...
  public:
    ...
    // Drops names this chain can't serve, preserving order. Configs written before built-in sources became always-on still list "embedded"/"sidecar".
