...
%bcond_with qt6
%if %{with qt6}
BuildRequires: gcc make cmake nasm qt6-base-common-devel qt6-multimedia-devel qt6-widgets-devel qt6-concurrent-devel
%else
BuildRequires: gcc make cmake nasm libqt5-qtbase-devel libqt5-qtmultimedia-devel libqt5-qtx11extras-devel
%endif
